...
const (
	User_Register_FullMethodName         = "/api.mini.user.v1.User/Register"
	User_Login_FullMethodName            = "/api.mini.user.v1.User/Login"
	User_GetLoginUserInfo_FullMethodName = "/api.mini.user.v1.User/GetLoginUserInfo"
)
...
type UserClient interface {
	...
	// 获取登录的用户信息
	GetLoginUserInfo(ctx context.Context, in *GetLoginUserInfoReq, opts ...grpc.CallOption) (*GetLoginUserInfoResp, error)
}
...
func (c *userClient) GetLoginUserInfo(ctx context.Context, in *GetLoginUserInfoReq, opts ...grpc.CallOption) (*GetLoginUserInfoResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetLoginUserInfoResp)
...
func (UnimplementedUserServer) GetLoginUserInfo(context.Context, *GetLoginUserInfoReq) (*GetLoginUserInfoResp, error) {
...
var User_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.mini.user.v1.User",
	...
	Metadata: "mini/user/v1/user.proto",
}
