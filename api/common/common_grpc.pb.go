...
const (
	Common_Ping_FullMethodName = "/api.common.Common/Ping"
)
...
func (c *commonClient) Ping(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*PingResp, error) {
...
func (UnimplementedCommonServer) Ping(context.Context, *Empty) (*PingResp, error) {
...
func _Common_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommonServer).Ping(ctx, req.(*Empty))
	}
